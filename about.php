    ...
    <div class="about-header">
      ...
      <div class="card-container">
        ...
        <div class="person-card" data-aos="fade-up">
          ...
          <p class="course">BS COMPUTER SCIENCE</p>
          <p>
			Machine learning plays an important role in achieving an outcome that is beneficial to humanity. Algorithms that can provide effective solutions and accurate results.
          </p>
        </div>
      </div>
    </div>
