        ...
        <div class="container">
            ...
            <div class="result-container">
                <div class="input-container">
                    ...
                    <input class="input" name="value" type="text" value="0" id="field" autocomplete="off" />
                </div>
                <!-- loader -->
                ...
                <div class="result">
                    ...
                    <p>Your Current Geolocation coordinates</p>
                    <div class="box-wrapper">
                        <div class="box-container">
...
<script type="text/javascript">
    //initialize map
    //hyvbrid
    //https://api.maptiler.com/maps/hybrid/{z}/{x}/{y}.jpg?key=h9u3QukA4OHsd5YKyhQz
    //basic
    //https://api.maptiler.com/maps/basic/{z}/{x}/{y}.png?key=h9u3QukA4OHsd5YKyhQz
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function(location) {
            ...
            startingpoint = L.marker(latlng).bindPopup("Current Location").openOn(map).addTo(map);
            $('#lat').html(latlng.lat)
